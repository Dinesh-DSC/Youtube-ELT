...
default_args = {
    ...
    "email": "dinesh.dc724@gmail.com",
    # "retries": 1,
    # "retry_delay": timedelta(minutes=5),
    "max_active_runs": 1,
    "dagrun_timeout": timedelta(hours=1),
    "start_date": datetime(2025, 1, 1, tzinfo=local_tz),
    # "end_date": atetime(2030, 12, 31, tzinfo=local_tz),
}
...
with DAG(
    dag_id="update_db",
    default_args=default_args,
    description="DAG to process JSON file and insert data into staging and core tables",
    catchup=False,
    schedule=None
) as dag_update:
...
with DAG(
    dag_id="data_quality",
    default_args=default_args,
    description="DAG to check the data quality for both db layers",
    catchup=False,
    schedule=None
) as dag_quality:
